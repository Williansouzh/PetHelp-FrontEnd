          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-8">
            <div className="flex flex-col justify-center">
              ...
              <p className="mt-6 text-lg text-gray-600">
                Ajude a transformar vidas! Na PetHelp, conectamos animais que
                precisam de um lar com pessoas que querem fazer a diferença.
                Adote, denuncie maus-tratos e faça parte dessa corrente do bem.
              </p>
            ...
            <div className="flex items-center justify-center">
              <Image
                src="/dogs/dog_principalpage.jpg"
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
              Como a PetHelp funciona
            </h2>
            <p className="mt-4 text-lg text-gray-600">
              Facilitamos o processo de adoção e denúncia para ajudar mais
              animais
            </p>
          </div>
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="mt-2 text-center text-gray-600">
                  Encontre o pet ideal para sua família através de um processo
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="mt-2 text-center text-gray-600">
                  Faça denúncias de forma anônima e segura para proteger animais
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="mt-2 text-center text-gray-600">
                  Conectamos ONGs e protetores independentes com pessoas
      ...
      <section className="py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">
              Veja como a adoção transformou a vida dessas famílias
            </p>
          </div>
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="mt-2 text-center text-gray-600">
                  "Adotar o Thor foi a melhor decisão que tomamos. Ele trouxe
                  tanta alegria para nossa família!"
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="mt-2 text-center text-gray-600">
                  "A Luna estava em situação de rua quando a encontramos através
                  da PetHelp. Hoje ela é parte da família."
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="mt-2 text-center text-gray-600">
                  "O Simba estava em um abrigo há mais de 2 anos. Graças à
                  PetHelp, encontramos um ao outro."
                </p>
              </CardContent>
            </Card>
          </div>
