...
import { PlusCircle, Edit, Trash2, Eye, AlertTriangle, CheckCircle2, PawPrint } from "lucide-react"
    ...
    <div className="container py-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
          ...
          <p className="text-gray-500">Gerencie seus pets e solicitações de adoção</p>
        </div>
        <Button asChild>
        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Os últimos pets cadastrados na plataforma</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <Card key={pet.id} className="overflow-hidden">
                    <div className="relative h-32">
                      {pet.image ? (
                        ...
                        <PlaceholderImage width={100} height={100} alt={pet.name} className="w-full h-full" />
                      )}
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>As últimas solicitações de adoção recebidas</CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
                    ...
                    <TableRow key={request.id}>
                      ...
                      <TableCell className="text-right">
                        <Button variant="ghost" size="sm" asChild>
                          <Link href={`/ongs/dashboard/solicitacoes/${request.id}`}>
            ...
            <CardFooter className="flex justify-center">
              <Button variant="outline" onClick={() => setSelectedTab("requests")}>
        ...
        <TabsContent value="pets" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Gerencie todos os pets cadastrados pela sua ONG</CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
                ...
                <TableBody>
                  {pets.map((pet) => (
                    <TableRow key={pet.id}>
                        ...
                        <div className="flex items-center gap-2">
                          <div className="relative w-8 h-8 rounded-full overflow-hidden">
                            {pet.image ? (
                              ...
                              <PlaceholderImage width={32} height={32} alt={pet.name} className="w-full h-full" />
                            )}
                          </div>
                          {pet.name}
                        </div>
                      ...
                      <TableCell>{new Date(pet.createdAt).toLocaleDateString("pt-BR")}</TableCell>
                      <TableCell className="text-right">
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem asChild>
                              <Link href={`/ongs/dashboard/pets/${pet.id}/editar`}>
        ...
        <TabsContent value="requests" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Gerencie todas as solicitações de adoção recebidas</CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
