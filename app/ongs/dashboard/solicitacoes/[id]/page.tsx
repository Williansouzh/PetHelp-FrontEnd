      ...
      <div className="container py-8">
        ...
        <div className="flex justify-center items-center h-64">
          <div className="text-center">
            ...
            <p className="text-gray-500">Carregando informações da solicitação...</p>
          </div>
        </div>
      </div>
    )
  ...
  return (
    <div className="container py-8">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          <p className="text-sm text-gray-500 mr-2">Status: {getStatusBadge(request.status)}</p>
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      Você está prestes a recusar a solicitação de adoção de {request.requesterName} para o pet{" "}
                      {request.petName}.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Dados pessoais de quem solicitou a adoção</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-2">
                  <Home className="h-5 w-5 text-gray-400 mt-0.5" />
                  <div>
                    <p className="text-sm font-medium text-gray-500">Tipo de moradia</p>
                    <p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-500">Tamanho da família</p>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-500">Horário de trabalho</p>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-500">Possui outros animais?</p>
                    <p>{request.hasOtherPets === "sim" ? "Sim" : "Não"}</p>
                    {request.hasOtherPets === "sim" && request.otherPetsDetails && (
                      <p className="text-sm text-gray-600 mt-1">{request.otherPetsDetails}</p>
                    )}
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-500">Motivação para adoção</p>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex flex-col items-center">
                <div className="relative w-32 h-32 rounded-lg overflow-hidden mb-4">
                  <PlaceholderImage width={128} height={128} alt={request.petName} className="w-full h-full" />
                </div>
            ...
            <CardFooter className="flex justify-center">
              <Button variant="outline" asChild>
                <Link href={`/ongs/dashboard/pets/${request.petId}`}>Ver todas as solicitações para este pet</Link>
              </Button>
            </CardFooter>
          </Card>
        </div>
