...
import { PawPrint, Target, Users, Code, Globe, Rocket, Award, Heart } from "lucide-react"
...
export default function SobrePage() {
  ...
  const technologies = {
    ...
    backend: ["C# .NET", "PostgreSQL", "JWT", "Google Cloud Storage", "Swagger"],
    ...
    <div className="container mx-auto py-8">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Uma plataforma desenvolvida com amor e tecnologia para conectar corações e transformar vidas
        </p>
      </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div className="space-y-4">
                <p className="text-lg leading-relaxed">
                  ...
                  <strong>1° Hackathon da Unicesumar em parceria com o Google Cloud</strong>, com o propósito de
                  conectar ONGs, protetores independentes e adotantes responsáveis.
                </p>
                <p className="text-lg leading-relaxed">
                  A aplicação também oferece um canal para denúncias de maus-tratos a animais com uso de geolocalização,
                  promovendo o bem-estar animal e incentivando adoções conscientes.
                </p>
                <p className="text-lg leading-relaxed">
                  Nosso projeto busca usar a tecnologia como aliada na construção de comunidades mais empáticas, seguras
                  e sustentáveis para os animais. Ao facilitar processos de adoção e denúncia, contribuímos para uma
                  sociedade mais justa — tanto para pessoas quanto para animais.
                </p>
              </div>
              <div className="flex justify-center">
                <PlaceholderImage
                  width={400}
                  height={300}
                  alt="Ilustração sobre o PetHelp"
      ...
      <section className="mb-16">
        <div className="text-center mb-8">
          <div className="flex justify-center items-center gap-3 mb-4">
            ...
            <h2 className="text-3xl font-bold">🎯 Propósito e Impacto Social</h2>
          </div>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            O PetHelp foi idealizado com base nos Objetivos de Desenvolvimento Sustentável (ODS) da ONU
          </p>
        </div>
      ...
      <section className="mb-16">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Nosso time multidisciplinar uniu habilidades de desenvolvimento frontend e backend para entregar uma solução
            sólida e de impacto
          </p>
        </div>
            ...
            <Card key={index} className="h-full">
              <CardContent className="p-6 text-center">
                <div className="flex justify-center mb-4">
                  <PlaceholderImage width={100} height={100} alt={member.name} className="rounded-full" />
                </div>
                <h3 className="font-bold text-xl mb-2">{member.name}</h3>
                <Badge variant="outline" className="mb-4 bg-pink-50 text-pink-700">
                  {member.role}
                </Badge>
      ...
      <section className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card>
            <CardContent className="p-6">
              <h3 className="font-bold text-lg mb-4 text-pink-600">APIs Externas</h3>
              <div className="space-y-2">
          ...
          <Card>
            <CardContent className="p-6">
              <h3 className="font-bold text-lg mb-4 text-pink-600">Hospedagem</h3>
              <div className="space-y-2">
        ...
        <Card className="bg-gradient-to-r from-pink-50 to-purple-50">
          <CardContent className="p-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div className="space-y-4">
                <p className="text-lg leading-relaxed">
                  O <strong>1º Hackathon Unicesumar + Google Cloud</strong> foi voltado a estudantes de cursos EaD da
                  área de TI, promovendo inovação, impacto social e sustentabilidade.
                </p>
                <p className="text-lg leading-relaxed">
                  Durante o evento, fomos desafiados a desenvolver um MVP utilizando Google Cloud para solucionar
                  problemas reais, como acessibilidade digital e responsabilidade social — temas centrais no
                  desenvolvimento do PetHelp.
                </p>
                <p className="text-lg leading-relaxed">
                  O evento ofereceu capacitações oficiais, mentoria especializada, certificação Google Cloud e
                  oportunidades de networking, como a participação na Job Fair Google, conectando talentos com o
                  mercado.
                </p>
              </div>
              <div className="flex justify-center">
          ...
          <CardContent className="p-8 text-center">
            ...
            <div className="max-w-4xl mx-auto space-y-6">
              <p className="text-xl leading-relaxed">
                Acreditamos que a tecnologia pode transformar realidades. O PetHelp é apenas o começo: nosso sonho é
                expandir a plataforma, formar parcerias com ONGs reais e continuar desenvolvendo soluções tecnológicas
                que gerem impacto social verdadeiro.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                ...
                <div className="bg-white/10 rounded-lg p-6">
                  ...
                  <p className="text-sm">Conectar com ONGs e protetores reais</p>
                </div>
                <div className="bg-white/10 rounded-lg p-6">
                  <Heart className="h-8 w-8 mx-auto mb-4" />
                  <h3 className="font-bold text-lg mb-2">Impacto</h3>
                  <p className="text-sm">Salvar mais vidas e criar mais lares</p>
                </div>
              </div>
            </div>
          </CardContent>
